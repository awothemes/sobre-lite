	...
	function sobre_lite_copyright(){
		...
		echo '<div class="col-sm-12 copyright text-center"><span>';
			...
			if (!sobre_lite_get_option('footer_copyright')){
					printf(wp_kses_post('&copy; %s Sobre Lite Theme | Powered by <a target="blank" rel="designer nofollow" href="https://sobre.cc">Sobre WordPress Theme</a>', 'sobre-lite'), date('Y')) ;
			} 
			else{
